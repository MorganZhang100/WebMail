...
public class HomeSentFolderPost extends PostHandler {
	public HomeSentFolderPost(HttpServletRequest request, HttpServletResponse response) {
	...
	public void body() throws IOException, SQLException, ClassNotFoundException, JSONException {
        ...
        ArrayList<MailModule> mailList = mail.getBriefUserSentMails(user.getUser_id());
        ...
        for(i=0;i<mailList.size();i++) {
            ...
            oneMailBrief.put("to_name",mail.getToFirstAddress());
