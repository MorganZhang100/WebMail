...
public class HomeSentDetail extends PostHandler {
	public HomeSentDetail(HttpServletRequest request, HttpServletResponse response) {
	...
	public void body() throws IOException, SQLException, ClassNotFoundException, JSONException {
        ...
        int sentIntMailId = Integer.parseInt(mail_id);

        UserModule user = new UserModule();
        user.getCurrentUser(request);

        MailModule mail = new MailModule(sentIntMailId,user);
